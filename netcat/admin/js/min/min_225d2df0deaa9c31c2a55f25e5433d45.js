...
/*
 ...
 - move CSS rule loading out of the plugin
 - investigate catch-all Touch event
 ...
 - borders on selectionDivs are wonky
 */
function iOSselection(cm, enabled) {
    ...
    CodeMirror.replaceLogicalRect(function(elt){
        var bcr = elt.getBoundingClientRect(), // this uses page coordinates
            BR = window.webkitConvertPointFromPageToNode(elt, new WebKitPoint(bcr.right, bcr.bottom)),
            TL = window.webkitConvertPointFromPageToNode(elt, new WebKitPoint(bcr.left, bcr.top));
        return {left: TL.x, top: TL.y, right: BR.x, bottom: BR.y, height: BR.y-TL.y, width: BR.x-TL.x};
    });
    ...
    function drawTool(e, x, y){
        ...
        function drawMagnifier(){
            ...
            magnifiedStuff.style.top  = (-y+wrapper.offsetTop+magnifier.offsetHeight/4)*zoom+"px";
