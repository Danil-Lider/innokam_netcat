...
/* $Id: nc_drag.class.js 2333 2008-10-25 12:32:46Z vadim $ */
...
var nc_drag = {
	...
	start: function(e) {
		...
		document.onmousemove = nc_drag.drag;
		document.onmouseup = nc_drag.end;
	...
	drag: function(e) {
      ...
      if (o.yMapper) ny = o.yMapper(x);
		...
		nc_drag.obj.root.style[o.hmode ? "left" : "right"] = nx + "px";
		nc_drag.obj.root.style[o.vmode ? "top" : "bottom"] = ny + "px";
		nc_drag.obj.lastMouseX	= ex;
		nc_drag.obj.lastMouseY	= ey;

		nc_drag.obj.root.onDrag(nx, ny);
		return false;
	},
		...
		nc_drag.obj.root.onDragEnd( parseInt(nc_drag.obj.root.style[nc_drag.obj.hmode ? "left" : "right"]), parseInt(nc_drag.obj.root.style[nc_drag.obj.vmode ? "top" : "bottom"]) );
    nc_drag.obj = null;
	},
