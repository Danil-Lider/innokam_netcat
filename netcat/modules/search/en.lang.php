...
define("NETCAT_MODULE_SEARCH_SUBDIVISION_NAME", "Search");
define("NETCAT_MODULE_SEARCH_INFOBLOCK_FORM_NAME", "Search form");
define("NETCAT_MODULE_SEARCH_INFOBLOCK_OTHERS_NAME", "By others");
define("NETCAT_MODULE_SEARCH_INFOBLOCK_SUBDIVISIONS_NAME", "By sections");
define("NETCAT_MODULE_SEARCH_INFOBLOCK_GOODS_NAME", "By goods");
...
define("NETCAT_MODULE_SEARCH_ADMIN_RULE_INTERVAL_EVERY_N_HOURS", "every %s hours, begin at %s");
...
define("NETCAT_MODULE_SEARCH_NO_DOM_EXTENSION_ERROR", "The <a href='http://php.net/DOM'>dom</a> extension must be enabled.");
define("NETCAT_MODULE_SEARCH_NO_MBSTRING_EXTENSION_ERROR", "The <a href='http://php.net/mbstring'>mbstring</a> extension must be enabled.");
define("NETCAT_MODULE_SEARCH_NO_OPENSSL_EXTENSION_ERROR", "The <a href='http://php.net/openssl'>openssl</a> extension must be enabled.");
