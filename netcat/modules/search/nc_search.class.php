...
class nc_search {
    ...
    const SEARCH_RESULT_COMPONENT_KEYWORD = 'netcat_service_search_result';
     ...
     * @return null|string
     */
    static public function get_provider_backup_class_name() {
     ...
     * @return array
     */
    static protected function check_sites_language() {
     ...
     */
    static public function check_environment() {
    ...
    public static function create_search_result_subdivision($site_id) {
        ...
        $search_result_component_others_id = self::get_search_result_template_id($search_result_component_id, self::SEARCH_RESULT_COMPONENT_TEMPLATE_DEFAULT_OTHERS);
        ...
        if ($search_result_component_goods_id && nc_module_check_by_keyword('netshop')) {
            $nc_core->sub_class->create($search_result_component_id, array(
                'Subdivision_ID' => $subdivision_id,
            ...
            $nc_core->sub_class->create($search_result_component_id, array(
                ...
                'Class_Template_ID' => $search_result_component_others_id,
                'EnglishName' => 'others',
            ));
        }
