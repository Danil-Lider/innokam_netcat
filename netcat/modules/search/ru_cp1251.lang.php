...
/* $Id: ru_cp1251.lang.php 8184 2012-10-10 12:20:57Z ewind $ */

define("NETCAT_MODULE_SEARCH_TITLE", "Поиск по сайту");
define("NETCAT_MODULE_SEARCH_DESCRIPTION", "Индексирование и поиск по сайту.");

define("NETCAT_MODULE_SEARCH_SUBDIVISION_NAME", "Поиск");
define("NETCAT_MODULE_SEARCH_INFOBLOCK_FORM_NAME", "Форма поиска");
define("NETCAT_MODULE_SEARCH_INFOBLOCK_OTHERS_NAME", "По прочему");
define("NETCAT_MODULE_SEARCH_INFOBLOCK_SUBDIVISIONS_NAME", "По разделам");
define("NETCAT_MODULE_SEARCH_INFOBLOCK_GOODS_NAME", "По товарам");
...
define("NETCAT_MODULE_SEARCH_NO_DOM_EXTENSION_ERROR", "Для работы модуля необходимо расширение <a href='http://php.net/DOM'>dom</a>.");
define("NETCAT_MODULE_SEARCH_NO_MBSTRING_EXTENSION_ERROR", "Для работы модуля необходимо расширение <a href='http://php.net/mbstring'>mbstring</a>.");
define("NETCAT_MODULE_SEARCH_NO_OPENSSL_EXTENSION_ERROR", "Для работы модуля необходимо расширение <a href='http://php.net/openssl'>openssl</a>.");
...
define("NETCAT_MODULE_SEARCH_CANNOT_OPEN_INDEX_ERROR", "Невозможно открыть поисковый индекс. ".
        "Пожалуйста, сотрите все файлы в папке <i>%s</i>, после чего запустите полное переиндексирование всех сайтов. ");
