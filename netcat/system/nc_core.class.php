...
//            $action = "message";
    ...
    public function get_memory_limit() {
        $memory_limit = $this->int_from_bytes_string(ini_get('memory_limit'));
        if ($memory_limit < 0) {
            $memory_limit = 0;
        }
        return $memory_limit;
    ...
    /**
     * Переводит строку вида "1 MB", "1 KB" в соответствующие количество байт
     * @param $string
     * @return bool|int
     */
    protected function int_from_bytes_string($string) {
